...
def main():
    ...
    parser.add_argument('--input_training_file', default='violin_fragments_train.txt')
    parser.add_argument('--input_validation_file', default='violin_fragments_test.txt')
    ...
    a = parser.parse_args()
    a.fine_tuning = False
    print('Fine tuning : ', a.fine_tuning)
