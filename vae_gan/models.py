...
class Encoder(nn.Module):
    def __init__(self, in_channels=3, dim=64, n_downsample=2, dropout=0.0):
        ...
        # Residual blocks
        for _ in range(4):
            layers += [ResidualBlock(dim, dropout)]
...
class Generator(nn.Module):
    def __init__(self, out_channels=3, dim=64, n_upsample=2, shared_block=None, dropout=0.0):
